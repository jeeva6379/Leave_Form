...
mongoose
  .connect(
    "mongodb://jeevanantham:o9eSnZ7j73ac5DdK@ac-qlqdxc8-shard-00-00.iwinedq.mongodb.net:27017,ac-qlqdxc8-shard-00-01.iwinedq.mongodb.net:27017,ac-qlqdxc8-shard-00-02.iwinedq.mongodb.net:27017/?replicaSet=atlas-h52vaz-shard-0&ssl=true&authSource=admin",
    {
      ...
      <tr>
          <td colspan="2" style="text-align: center; padding: 10px; border-radius: 10px;">
              <div style="display: flex; flex-wrap: wrap; justify-content: center; gap: 10px;">
                  <a href="http://localhost:${port}/leave-response?response=accepted&email=${user_email}&id=${item._id}" style="display: inline-block; margin-right:16px; background-color: #83D475; color: black; padding: 10px; text-decoration: none; width: 100px; animation-name: scale-in; animation-duration: 0.5s; animation-timing-function: ease-in-out;">Accept</a>
                  <a href="http://localhost:${port}/leave-response?response=rejected&email=${user_email}&id=${item._id}" style="display: inline-block; background-color: #f07470; color: white; padding: 10px; text-decoration: none; width: 100px; animation-name: slide-in; animation-duration: 0.5s; animation-timing-function: ease-in-out;">Reject</a>
              </div>
          </td>
      </tr>
  </table>`;
