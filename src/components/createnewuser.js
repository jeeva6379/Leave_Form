...
function CreateNewUser() {
  ...
  const handleButtonClick1 = () => {
    window.location.href = "/userstored";
  };
    ...
    <div className="mx-auto" style={mainStyles}>
      <div className="signup" style={signupStyles}>
        ...
        <Form onSubmit={handleSubmit}>
          ...
          <Button type="submit" variant="text-dark" onClick={handleButtonClick} className="align-items-center me-5"><BiArrowBack className="me-2" />Back</Button>
